...
import logging
import sys
from pyBaseApp import Package
from pyBaseApp import Configuration, Options

if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description='create a default app with package feature')
    parser.add_argument('package', help='package the app thanks to package.yml settings available from project root')
